...
inline void RegLuaMath()
{
	getGlobalNamespace(LSTATE)
		...
		.addOperatorGlobal("__add", static_cast<Matrix (*)(const Matrix&, const Matrix&)>(&operator+))
		.addOperatorGlobal("__sub", static_cast<Matrix (*)(const Matrix&, const Matrix&)>(&operator-))
		.addOperatorGlobal("__mul", static_cast<Matrix (*)(const Matrix&, const Matrix&)>(&operator*))
		.addOperatorGlobal("__div", static_cast<Matrix (*)(const Matrix&, const Matrix&)>(&operator/))
		.addFunction("__unm", &Matrix::operator-)
		.addFunction("__eq", &Matrix::operator==)
		...
		.addOperatorGlobal("__add", static_cast<Vector2 (*)(const Vector2&, const Vector2&)>(&operator+))
		.addOperatorGlobal("__sub", static_cast<Vector2 (*)(const Vector2&, const Vector2&)>(&operator-))
		.addOperatorGlobal("__mul", static_cast<Vector2 (*)(const Vector2&, const Vector2&)>(&operator*))
		.addOperatorGlobal("__div", static_cast<Vector2 (*)(const Vector2&, const Vector2&)>(&operator/))
		.addFunction("__unm", &Vector2::operator-)
		...
		.addOperatorGlobal("__add", static_cast<Vector3 (*)(const Vector3&, const Vector3&)>(&operator+))
		.addOperatorGlobal("__sub", static_cast<Vector3 (*)(const Vector3&, const Vector3&)>(&operator-))
		.addOperatorGlobal("__mul", static_cast<Vector3 (*)(const Vector3&, const Vector3&)>(&operator*))
		...
		.addOperatorGlobal("__add", static_cast<Vector4 (*)(const Vector4&, const Vector4&)>(&operator+))
		.addOperatorGlobal("__sub", static_cast<Vector4 (*)(const Vector4&, const Vector4&)>(&operator-))
		.addOperatorGlobal("__mul", static_cast<Vector4 (*)(const Vector4&, const Vector4&)>(&operator*))
		.addOperatorGlobal("__div", static_cast<Vector4 (*)(const Vector4&, const Vector4&)>(&operator/))
		.addFunction("__unm", &Vector4::operator-)
