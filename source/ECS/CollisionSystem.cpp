...
void CollisionSystem::RegLuaClass()
{
	getGlobalNamespace(LSTATE)
		...
		.addFunction("AddBoxShape", &CollisionSystem::AddBoxCollider)
		.addFunction("AddSphereShape", &CollisionSystem::AddSphereCollider)
		.addFunction("AddConeShape", &CollisionSystem::AddConeCollider)
		.addFunction("AddCylinderShape", &CollisionSystem::AddCylinderCollider)
		.addFunction("AddCapsuleShape", &CollisionSystem::AddCapsuleCollider)
