...
function GuiButton:ApplyDisable()
    ...
    if self.icon_mat ~= nil then
        self.icon_mat:SetVectorByID(self.icon.color_nonactive, 1)
    end
...
function GuiButton:ApplyNone()
    ...
    if self.icon_mat ~= nil then
        self.icon_mat:SetVectorByID(self.icon.color, 1)
    end
    if self.str ~= nil then
...
function GuiButton:ApplyPress()
    ...
    if self.icon_mat ~= nil then
        self.icon_mat:SetVectorByID(self.icon.color_press, 1)
    end
    if self.str ~= nil then
...
function GuiButton:ApplyHover()
    ...
    if self.icon_mat ~= nil then
        self.icon_mat:SetVectorByID(self.icon.color_hover, 1)
    end
    if self.str ~= nil then
...
function GuiButton:onTick(dt)
    if self.anim_go ~= 0 then
        ...
        if self.icon_mat ~= nil then
            self.icon_mat:SetVectorByID(color_icon, 1)
        end
        if self.str ~= nil then
