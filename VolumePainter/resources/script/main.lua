script_env = {
	--common_path = './../../common/resources/script/',
	--common_guipath = './../../common/resources/gui/',
...
package.path = script_env.path..'?'..script_env.cpl_ext..';'..
	...
	--script_env.common_path .. '?' .. script_env.src_ext .. ';' .. -- only sources in common
	--script_env.common_guipath .. '?' .. script_env.src_ext .. ';'
